...
| ------------------ | -------------------------------------- | -------------- | --------------------- | -------------------------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------- |
| 1.3.0              | corpus_dpe.csv                         | 5%             | 9980                  | 4508 (+19)                       | 45%                | [Voir le détail](https://open3cl.github.io/engine/reports/corpus?corpus_file=corpus_dpe.csv)                          |
| 1.3.0              | dpe_immeuble_chauffage_individuel.csv  | 5%             | 9998                  | 5459 (+184)                      | 55% (+2%)          | [Voir le détail](https://open3cl.github.io/engine/reports/corpus?corpus_file=dpe_immeuble_chauffage_individuel.csv)   |
| 1.3.0              | dpe_immeuble_chauffage_collectif.csv   | 5%             | 10000                 | 5848 (+101)                      | 58% (+1%)          | [Voir le détail](https://open3cl.github.io/engine/reports/corpus?corpus_file=dpe_immeuble_chauffage_collectif.csv)    |
| 1.3.0              | dpe_immeuble_chauffage_mixte.csv       | 5%             | 10000                 | 4018 (+876)                      | 40% (+9%)          | [Voir le détail](https://open3cl.github.io/engine/reports/corpus?corpus_file=dpe_immeuble_chauffage_mixte.csv)        |
