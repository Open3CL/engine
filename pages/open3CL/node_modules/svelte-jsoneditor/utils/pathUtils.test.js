...
import { createLodashPropertySelector, createPropertySelector, parseJSONPath, pathToOption, stringifyJSONPath } from './pathUtils.js';
describe('pathUtils', () => {
    ...
    test('createLodashPropertySelector', () => {
        ...
        strictEqual(createLodashPropertySelector(['foo', 'prop-with-hyphens']), '["foo","prop-with-hyphens"]');
        strictEqual(createLodashPropertySelector(['foo', 'prop with spaces']), '["foo","prop with spaces"]');
