...
import { calculatePosition, convertValue, countCharacterOccurrences, estimateSerializedSize, isContent, isEqualParser, isJSONContent, isLargeContent, needsFormatting, isTextContent, normalizeJsonParseError, parsePartialJson, toJSONContent, toTextContent, validateContentType, parseAndRepairOrUndefined } from './jsonUtils.js';
...
describe('jsonUtils', () => {
    ...
    test('should validate content type', () => {
        ...
        deepStrictEqual(validateContentType({ text: [1, 2, 3] }), 'Content "text" property must be a string containing a JSON document. Did you mean to use the "json" property instead?');
        deepStrictEqual(validateContentType({ json: [1, 2, 3], text: '[1,2,3]' }), 'Content must contain either a property "json" or a property "text" but not both');
        deepStrictEqual(validateContentType({}), 'Content must contain either a property "json" or a property "text"');
    ...
    test('toTextContent', () => {
        ...
        deepStrictEqual(toTextContent(
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        { json: [new LosslessNumber('1'), new LosslessNumber('2'), new LosslessNumber('3')] }, 2, LosslessJSONParser), { text: '[\n  1,\n  2,\n  3\n]' });
    });
    test('toJSONContent', () => {
