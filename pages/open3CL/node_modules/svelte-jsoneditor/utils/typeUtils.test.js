...
import { getColorCSS, isColor, isInteger, isObject, isObjectOrArray, isStringContainingPrimitiveValue, isTimestamp, stringConvert, valueType } from './typeUtils.js';
...
describe('typeUtils', () => {
    ...
    test('valueType', () => {
        ...
        strictEqual(valueType(new LosslessNumber('123'), LosslessJSONParser), 'number');
        strictEqual(valueType(new LosslessNumber('2.4e3'), LosslessJSONParser), 'number');
        strictEqual(valueType(new LosslessNumber('-4.0'), LosslessJSONParser), 'number');
    });
