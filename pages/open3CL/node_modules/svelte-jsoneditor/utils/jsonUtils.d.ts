 ...
 */
export declare function calculatePosition(text: string, line: number, column: number): number | undefined;
 ...
 * or null otherwise
 */
export declare function validateContentType(content: unknown): string | undefined;
/**
