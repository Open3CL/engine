...
describe('jsonSchemaUtils', () => {
    ...
    describe('findSchema', () => {
        ...
        test('should find schema inside an array item', () => {
            ...
            assert.strictEqual(findSchema(schema, {}, ['job', '0', 'company']), schema.properties.job.items.properties.company);
        });
        test('should find schema within multi-level object properties', () => {
            ...
            assert.strictEqual(findSchema(schema, {}, path), schema.properties.levelTwo.properties.levelThree);
            path = ['levelTwo', 'levelThree', 'bool'];
            assert.strictEqual(findSchema(schema, {}, path), schema.properties.levelTwo.properties.levelThree.properties.bool);
        });
        ...
        describe('with $ref', () => {
            ...
            test('should find a referenced schema property', () => {
                ...
                assert.strictEqual(findSchema(schema, { foo: fooSchema }, path), fooSchema.properties.levelTwo);
            });
            test('should find a referenced schema definition', () => {
                ...
                const path = ['foo', '0'];
                assert.strictEqual(findSchema(schema, { foo: fooSchema }, path), fooSchema.definitions.some_def);
            });
            test('should find a referenced schema definition 2', () => {
                ...
                assert.strictEqual(findSchema(schema, { foo: fooSchema }, path), fooSchema.definitions.some_def.properties.propA);
            });
            test('should find a referenced schema definition 3', () => {
                ...
                assert.strictEqual(findSchema(schema, { foo: fooSchema }, path), fooSchema.definitions.some_def.properties.propA.properties.propA1);
            });
        });
        ...
        describe('with $ref to external definition', () => {
            test('should find a referenced schema', () => {
                ...
                assert.notStrictEqual(findSchema(schema, { 'definitions.json': definitions }, path), foundSchema);
            });
        });
        describe('with pattern properties', () => {
            ...
            test('should find schema within multi-level object properties', () => {
                ...
                path = ['levelTwo', 'levelThree'];
                assert.strictEqual(findSchema(schema, {}, path), schema.properties.levelTwo.properties.levelThree, 'level three');
                path = ['levelTwo', 'levelThree', 'bool'];
                assert.strictEqual(findSchema(schema, {}, path), schema.properties.levelTwo.properties.levelThree.properties.bool, 'normal property');
            });
            test('should find schema for pattern properties', () => {
                ...
                let path = ['foo1'];
                assert.strictEqual(findSchema(schema, {}, path), schema.patternProperties['^foo[0-9]'], 'first pattern property');
                path = ['bar5'];
                assert.strictEqual(findSchema(schema, {}, path), schema.patternProperties['^bar[0-9]'], 'second pattern property');
            });
            test('should find schema for multi-level pattern properties', () => {
                ...
                assert.strictEqual(findSchema(schema, {}, path), schema.patternProperties['^foo[0-9]'].properties.fooChild.properties.fooChild2, 'first pattern property child of child');
                path = ['bar5', 'barChild'];
                assert.strictEqual(findSchema(schema, {}, path), schema.patternProperties['^bar[0-9]'].properties.barChild, 'second pattern property child');
            });
            test('should return null for path that has no schema', () => {
                const schema = {
                    type: 'object',
            ...
            test('should return additionalProperties schema', () => {
                ...
                let path = ['company2'];
                assert.strictEqual(findSchema(schema, {}, path), schema.additionalProperties, 'additionalProperties schema');
                path = ['nested', 'virtual'];
                assert.strictEqual(findSchema(schema, {}, path), schema.properties.nested.additionalProperties, 'additionalProperties schema');
            });
        });
    });
    describe('findEnum', () => {
