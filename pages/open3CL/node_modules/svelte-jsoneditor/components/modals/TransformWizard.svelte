...
let filterRelation = filterRelationOptions.find((option) => option.value === queryOptions.filter?.relation) ??
...
let sortDirection = sortDirectionOptions.find((option) => option.value === queryOptions.sort?.direction) ??
