...
<script lang="ts">import { faArrowDown, faCheck, faExclamationTriangle, faTimes, faWrench } from '@fortawesome/free-solid-svg-icons';
...
.jse-json-repair-component .jse-info {
