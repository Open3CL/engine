<script lang="ts">import { Mode } from '../../types.js';
...
import { isMenuSpace, isModeHistoryItem } from '../../typeguards.js';
import { cloneDeep } from 'lodash-es';
import { createHistoryInstance } from '../../logic/history';
...
export let tabSize;
export let truncateTextSize;
export let externalMode;
...
export function collapse(path, recursive) {
    if (refTreeMode) {
