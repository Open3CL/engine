import { faCheckSquare, faClone, faCopy, faCut, faPaste, faPen, faPlus, faSquare, faTrashCan } from '@fortawesome/free-solid-svg-icons';
import { isKeySelection, isMultiSelection, isValueSelection } from '../../../../logic/selection';
import { getIn } from 'immutable-json-patch';
import { getFocusPath, singleItemSelected } from '../../../../logic/selection';
import { isObjectOrArray } from '../../../../utils/typeUtils';
import { getEnforceString } from '../../../../logic/documentState';
export default function ({ json, documentState, selection, readOnly, onEditValue, onEditRow, onToggleEnforceString, onCut, onCopy, onPaste, onRemove, onDuplicateRow, onInsertBeforeRow, onInsertAfterRow, onRemoveRow }) {
    const hasJson = json !== undefined;
    const hasSelection = !!selection;
    const focusValue = json !== undefined && selection ? getIn(json, getFocusPath(selection)) : undefined;
