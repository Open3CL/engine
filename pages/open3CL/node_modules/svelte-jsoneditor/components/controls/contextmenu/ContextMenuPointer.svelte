...
<script lang="ts">import { faCaretDown } from '@fortawesome/free-solid-svg-icons';
...
.jse-context-menu-pointer.jse-root {
  top: 0;
  right: calc(-2px - var(--jse-context-menu-pointer-size, calc(1em + 4px)));
}
.jse-context-menu-pointer.jse-insert {
  right: -1px;
}
...
.jse-context-menu-pointer.jse-selected:hover {
  background: var(--jse-context-menu-pointer-background-highlight, var(--jse-context-menu-background-highlight, #7a7a7a));
}</style>
