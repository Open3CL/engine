<script lang="ts">import DropdownButton from '../DropdownButton.svelte';
...
<style src="./ContextMenuDropDownButton.scss">/* over all fonts, sizes, and colors */
...
button.jse-context-menu-button:hover {
  background: var(--jse-context-menu-background-highlight, #7a7a7a);
}
button.jse-context-menu-button:focus {
  background: var(--jse-context-menu-background-highlight, #7a7a7a);
  z-index: 1;
}
button.jse-context-menu-button:disabled {
  color: var(--jse-context-menu-color-disabled, #9d9d9d);
  background: unset;
}
button.jse-context-menu-button.left {
  text-align: left;
}
button.jse-context-menu-button :global(svg) {
  width: 16px;
}</style>
