...
<script lang="ts">import { debounce } from 'lodash-es';
...
import { createSearchAndReplaceAllOperations, createSearchAndReplaceOperations, search, searchNext, searchPrevious, updateSearchResult } from '../../logic/search.js';
