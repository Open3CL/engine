import { type JSONPatchAdd, type JSONPatchCopy, type JSONPatchDocument, type JSONPatchMove, type JSONPatchOperation, type JSONPath } from 'immutable-json-patch';
...
export declare function insert(json: unknown, selection: JSONSelection | undefined, clipboardText: string, parser: JSONParser): JSONPatchDocument;
export declare function moveInsideParent(json: unknown, selection: JSONSelection | undefined, dragInsideAction: DragInsideAction): JSONPatchDocument;
export declare function createNewValue(json: unknown | undefined, selection: JSONSelection | undefined, valueType: 'object' | 'array' | 'structure' | 'value'): unknown;
/**
...
export declare function createRemoveOperations(json: unknown, selection: JSONSelection): {
    newSelection: JSONSelection | undefined;
 ...
 */
export declare function createNestedValueOperations(operations: JSONPatchOperation[], json: unknown): (JSONPatchAdd | import("immutable-json-patch").JSONPatchRemove | import("immutable-json-patch").JSONPatchReplace | JSONPatchCopy | JSONPatchMove | import("immutable-json-patch").JSONPatchTest)[];
