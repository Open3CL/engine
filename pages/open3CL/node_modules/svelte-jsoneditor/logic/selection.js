...
export function getSelectionUp(json, documentState, selection, keepAnchorPath = false) {
    if (!selection) {
        return undefined;
    }
...
export function getSelectionDown(json, documentState, selection, keepAnchorPath = false) {
    if (!selection) {
        return undefined;
    }
 ...
 */
// TODO: unit test
export function findCaretAndSiblings(json, documentState, selection, includeInside) {
    if (!selection) {
...
export function getSelectionLeft(json, documentState, selection, keepAnchorPath = false, includeInside = true) {
    if (!selection) {
        return undefined;
    }
...
export function getSelectionRight(json, documentState, selection, keepAnchorPath = false, includeInside = true) {
    if (!selection) {
        return undefined;
    }
...
export function createKeySelection(path) {
    return { type: SelectionType.key, path };
}
export function createEditKeySelection(path, initialValue) {
    return { type: SelectionType.key, path, edit: true, initialValue };
}
export function createValueSelection(path) {
    return { type: SelectionType.value, path };
}
export function createEditValueSelection(path, initialValue) {
...
export function isEditingSelection(selection) {
    return ((isKeySelection(selection) || isValueSelection(selection)) &&
        selection.edit === true);
}
/**
...
// TODO: unit test
// eslint-disable-next-line consistent-return
export function fromSelectionType(selectionType, path) {
