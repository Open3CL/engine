...
import { hasSearchResults, isArrayRecursiveState, isObjectRecursiveState } from '../typeguards.js';
// TODO: comment
// TODO: unit test
export function updateSearchResult(newResultItems, previousResult) {
 ...
 */
export function filterKeySearchResults(searchResult) {
 ...
 */
export function filterValueSearchResults(searchResult) {
    const filtered = hasSearchResults(searchResult)
...
export function updateInSearchResults(json, searchResults, path, transform) {
    return updateInRecursiveState(json, searchResults, path, transform, searchResultsFactory);
}
export function toRecursiveSearchResults(json, searchResultItems) {
    return searchResultItems.reduce((recursiveState, searchResult) => {
...
export function flattenSearchResults(node) {
