...
function getFuncName(func) {
  var result2 = func.name + "", array = realNames_default[result2], length = hasOwnProperty8.call(realNames_default, result2) ? array.length : 0;
  while (length--) {
...
function isPrototype(value) {
  var Ctor = value && value.constructor, proto = typeof Ctor == "function" && Ctor.prototype || objectProto11;
  return value === proto;
}
...
var defaults = baseRest_default(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || eq_default(value, objectProto22[key]) && !hasOwnProperty19.call(object, key)) {
...
//# sourceMappingURL=chunk-6OGLXQQX.js.map
