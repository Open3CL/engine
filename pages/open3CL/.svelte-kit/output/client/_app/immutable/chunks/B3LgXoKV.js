var O = function (l, n) {
  ...
  y = (function () {
    function l(n, e) {
      ...
      try {
        for (
          var c = n[Symbol.iterator](), a;
          !(r = (a = c.next()).done) && (t.push(a.value), !(e && t.length === e));
          r = !0
        );
      } catch (s) {
        ((i = !0), (o = s));
    ...
    return function (n, e) {
      ...
      if (Symbol.iterator in Object(n)) return l(n, e);
...
String.prototype.padStart =
  String.prototype.padStart ||
  function (l, n) {
    for (var e = this; e.length < l;) e = n + e;
    return e;
  };
var I = {
  cb: '0f8ff',
...
function A(l) {
  var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1,
    e = n > 0 ? l.toFixed(n).replace(/0+$/, '').replace(/\.$/, '') : l.toString();
  return e || '0';
}
var N = (function () {
    function l(n, e, t, r) {
      ...
      function o(a) {
        if (a.startsWith('hsl')) {
          var s = a.match(/([\-\d\.e]+)/g).map(Number),
            p = y(s, 4),
            f = p[0],
            u = p[1],
            d = p[2],
          ...
          var m = a.match(/([\-\d\.e]+)/g).map(Number),
            h = y(m, 4),
            v = h[0],
            g = h[1],
            E = h[2],
      ...
      if (n !== void 0)
        if (Array.isArray(n)) this.rgba = n;
        else if (t === void 0) {
          var c = n && '' + n;
          c && o(c.toLowerCase());
        } else this.rgba = [n, e, t, r === void 0 ? 1 : r];
    }
    return (
      R(
        l,
        [
          {
            key: 'printRGB',
            value: function (e) {
              var t = e ? this.rgba : this.rgba.slice(0, 3),
                r = t.map(function (i, o) {
                  return A(i, o === 3 ? 3 : 0);
                });
          ...
          },
          {
            ...
            value: function (e) {
              var t = [360, 100, 100, 1],
                r = ['', '%', '%', ''],
                i = e ? this.hsla : this.hsla.slice(0, 3),
                o = i.map(function (c, a) {
        ...
        [
          {
            ...
            value: function (e, t, r) {
              (e.addEventListener(t, r, !1), this._events.push({ target: e, type: t, handler: r }));
            }
          },
          {
            key: 'remove',
            value: function (e, t, r) {
              this._events = this._events.filter(function (i) {
                ...
                return (
                  ...
                  t && t !== i.type && (o = !1),
                  r && r !== i.handler && (o = !1),
                  o && l._doRemove(i.target, i.type, i.handler),
                  !o
                );
              });
            }
...
function L(l, n, e) {
  ...
  (l.add(n, 'mousedown', function (a) {
    ...
    l.add(window, 'mousemove', o),
    l.add(n, 'touchmove', c),
    l.add(window, 'mouseup', function (a) {
      t = !1;
    }),
    ...
    R(l, [
      {
        ...
        value: function (e) {
          ...
          if (e instanceof HTMLElement) r.parent = e;
          else {
            (r.parent &&
              e.parent &&
              r.parent !== e.parent &&
              (this._events.remove(r.parent), (this._popupInited = !1)),
              i(e, r),
              e.onChange && (this.onChange = e.onChange),
              e.onDone && (this.onDone = e.onDone),
          ...
          if (c && r.popup && !this._popupInited) {
            ...
            (this._events.add(c, 'click', a),
              H(this._events, c, [' ', 'Spacebar', 'Enter'], a),
              (this._popupInited = !0));
      ...
      },
      {
        ...
        value: function (e) {
          ...
          r &&
            ...
            t !== x && this.settings.parent.focus(),
      ...
      },
      {
        ...
        value: function () {
          ...
          return (
            (this.domElement = i),
            (this._domH = _('.picker_hue', i)),
            (this._domSL = _('.picker_sl', i)),
            (this._domA = _('.picker_alpha', i)),
            (this._domEdit = _('.picker_editor input', i)),
            (this._domSample = _('.picker_sample', i)),
            (this._domOkay = _('.picker_done button', i)),
            (this._domCancel = _('.picker_cancel button', i)),
      ...
      },
      {
        ...
        value: function (e, t, r, i, o) {
          ...
          ([e, t, r, i].forEach(function (s, p) {
            ...
            (c.hsla = a),
            this._updateUI(o),
            this.onChange && !o.silent && this.onChange(c));
        }
      },
      {
        key: '_updateUI',
        value: function (e) {
          ...
          var t = this.colour,
            ...
            s = this._domSL,
            p = this._domA,
            f = _('.picker_selector', a),
            u = _('.picker_selector', s),
            d = _('.picker_selector', p);
          function b(M, S, C) {
            S.style.left = C * 100 + '%';
          }
          function m(M, S, C) {
          ...
          (b(a, f, r[0]),
            (this._domSL.style.backgroundColor = this._domH.style.color = i),
            b(s, u, r[1]),
            m(s, u, 1 - r[2]),
            (s.style.color = o),
            m(p, d, 1 - r[3]));
          var h = o,
            v = h.replace('hsl', 'hsla').replace(')', ', 0)'),
            g = 'linear-gradient(' + [h, v] + ')';
          if (((this._domA.style.background = g + ', ' + U), !e.fromEditor)) {
            var E = this.settings.editorFormat,
              k = this.settings.alpha,
              w = void 0;
            switch (E) {
              case 'rgb':
                w = t.printRGB(k);
...
})();
{
  ...
  ((D.textContent =
    ...
    document.documentElement.firstElementChild.appendChild(D),
    (K.StyleElement = D));
}
export { K as default };
