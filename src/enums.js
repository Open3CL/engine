/**
 * @typedef {Object} DpeConfig
 * @property {Record<number, string>} version
 * @property {Record<number, string>} modele_dpe
 * @property {Record<number, string>} usage_fonctionnel_batiment
 * @property {Record<number, string>} categorie_erp
 * @property {Record<number, string>} methode_application_dpe_log
 * @property {Record<number, string>} methode_application_dpe_ter
 * @property {Record<number, string>} sous_modele_dpe_ter
 * @property {Record<number, string>} calcul_echantillonnage
 * @property {Record<number, string>} periode_construction
 * @property {Record<number, string>} periode_isolation
 * @property {Record<number, string>} zone_climatique
 * @property {Record<number, string>} classe_altitude
 * @property {Record<number, string>} methode_saisie_u
 * @property {Record<number, string>} methode_saisie_u0
 * @property {Record<number, string>} methode_saisie_uporte
 * @property {Record<number, string>} methode_saisie_pont_thermique
 * @property {Record<number, string>} methode_saisie_perf_vitrage
 * @property {Record<number, string>} methode_saisie_carac_sys
 * @property {Record<number, string>} methode_saisie_q4pa_conv
 * @property {Record<number, string>} methode_saisie_fact_couv_sol
 * @property {Record<number, string>} classe_inertie
 * @property {Record<number, string>} type_adjacence
 * @property {Record<number, string>} cfg_isolation_lnc
 * @property {Record<number, string>} materiaux_structure_mur
 * @property {Record<number, string>} type_isolation
 * @property {Record<number, string>} type_doublage
 * @property {Record<number, string>} type_plancher_bas
 * @property {Record<number, string>} type_plancher_haut
 * @property {Record<number, string>} type_vitrage
 * @property {Record<number, string>} inclinaison_vitrage
 * @property {Record<number, string>} type_materiaux_menuiserie
 * @property {Record<number, string>} type_baie
 * @property {Record<number, string>} type_pose
 * @property {Record<number, string>} type_gaz_lame
 * @property {Record<number, string>} orientation
 * @property {Record<number, string>} type_fermeture
 * @property {Record<number, string>} type_porte
 * @property {Record<number, string>} type_liaison
 * @property {Record<number, string>} type_ventilation
 * @property {Record<number, string>} periode_installation_fr
 * @property {Record<number, string>} type_generateur_fr
 * @property {Record<number, string>} type_installation_solaire
 * @property {Record<number, string>} type_installation
 * @property {Record<number, string>} methode_calcul_conso
 * @property {Record<number, string>} usage_generateur
 * @property {Record<number, string>} cfg_installation_ch
 * @property {Record<number, string>} lien_generateur_emetteur
 * @property {Record<number, string>} cfg_installation_ecs
 * @property {Record<number, string>} type_generateur_ch
 * @property {Record<number, string>} type_emission_distribution
 * @property {Record<number, string>} temp_distribution_ch
 * @property {Record<number, string>} equipement_intermittence
 * @property {Record<number, string>} type_regulation
 * @property {Record<number, string>} periode_installation_emetteur
 * @property {Record<number, string>} type_chauffage
 * @property {Record<number, string>} type_generateur_ecs
 */
const enums = {
  version: {
